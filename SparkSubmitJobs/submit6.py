...
#Script for Mapping breaches related Server-Resource-Public-Unauthorized-Access

from pyspark import SparkContext, SparkConf
import re
fields_list=["gl2_remote_ip","message"]
custom_query='{ "query" :  { "query_string" : { "fields" : ["message"], "query" : "Did not receive identification string from", "use_dis_max" : true, minimum_should_match : 70} }}'
domain="Server-Resource-Public-Unauthorized-Access"
compliance_map="PCI"
