...
#Script for Mapping authentication failures from users and mapping the authentication and authorizatiopn management of environment.


from pyspark import SparkContext, SparkConf
import re
fields_list=["gl2_remote_ip","message"]
custom_query='{ "query" :  { "query_string" : { "fields" : ["message"], "query" : "authentication failure NOT root NOT ec2", "use_dis_max" : true, minimum_should_match : 70} }}'
domain="Access-And-Autorization-Management"
compliance_map="PCI"
