...
#Script for Mapping Cloud-Networks-And-Connections

from pyspark import SparkContext, SparkConf
import re
fields_list=["gl2_remote_ip","message"]
custom_query='{ "query" :  { "query_string" : { "fields" : ["message"], "query" : "No supported authentication methods available", "use_dis_max" : true, minimum_should_match : 70} }}'
domain="Cloud-Networks-And-Connections "
compliance_map="HIPAA PCI"
