...
#Script for Finding breaches related to Roles and Identity managament and breaches related to the same .

from pyspark import SparkContext, SparkConf
import re
fields_list=["gl2_remote_ip","message"]
custom_query='{ "query" :  { "query_string" : { "fields" : ["message"], "query" : "session opened for user NOT root NOT ec2", "use_dis_max" : true, minimum_should_match : 70} }}'
domain="Role-And-Identity-Management"
compliance_map="PCI HIPAA NIST"
